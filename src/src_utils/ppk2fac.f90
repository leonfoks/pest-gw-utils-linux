...
! -- Program PPK2FAC performs the first step in kriging from a set of
...
!    the value of each point contributes to the value at the grid cell.
	...
	write(amessage,5)
5	format(' Program PPK2FAC calculates point-to-cell factors by which kriging ',&
...
422           format(' Variogram "',a,'" uses the power model. Simple kriging ', &
          ...
          outfile,aoutfile,outunit,variance,pmx,itrans,num_pilot_points,regarray)
...
!              '   standard deviation  = ',f12.5,/)
      ...
      aoutfile,outunit,var_arr,pmx,itrans,npp,regarray)
